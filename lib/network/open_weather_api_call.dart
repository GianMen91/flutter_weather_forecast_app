...
import 'package:flutter_weather_forecast_app/network/app_url.dart';
...
class OpenWeatherApiCall {
  ...
  OpenWeatherApiCall({required AppUrl appUrl, required Dio dio})
      : _appUrl = appUrl,
        _dio = dio;
  ...
  Future<List<WeatherForecast>> loadWeatherForecast(
    ...
    final response = await _dio.get(_appUrl.weatherForecast(lon, lat));
